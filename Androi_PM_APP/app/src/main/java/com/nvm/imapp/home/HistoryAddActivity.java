...
public class HistoryAddActivity extends AppCompatActivity {
        RecyclerView recyclerViewH;
        List<Product> listH;
        ProductHistoryActivity productAdapterH;
        ...
        private void getLinkViews() {
            ...
            productAdapterH = new ProductHistoryActivity(HistoryAddActivity.this);
            recyclerViewH.setAdapter(productAdapterH);
            tb=findViewById(R.id.tb);
            recyclerViewH.setLayoutManager(new LinearLayoutManager(HistoryAddActivity.this));
        }
    private void checkSp(){
        ...
        private void getDatabase() {
            ...
            DatabaseReference databaseReference = firebaseDatabase.getReference(userID).child("History");
